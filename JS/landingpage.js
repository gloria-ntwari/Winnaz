document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelector(".review-section").addEventListener("mouseenter", stopSlideShow)
    document.querySelector(".review-section").addEventListener("mouseleave", startSlideShow)
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const testimonialSection = document.querySelector(".review-section")
